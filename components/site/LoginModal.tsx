      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            ...
            <Input id="email" placeholder="hello@repairsync.com" type="email" />
          </div>
          <div className="grid gap-2">
          ...
          <button className="mt-2 w-full rounded-xl ink-gradient px-4 py-3 text-sm font-medium text-black dark:text-white shadow-xl shadow-[#0e7c86]/25 transition-transform hover:scale-[1.02]">
            Sign In
          </button>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 rounded-xl border border-[var(--ink)]/20 bg-transparent px-4 py-2.5 text-sm font-medium text-[var(--ink)] transition-colors hover:bg-[var(--ink)]/5">
